	...
	exports["default"] = _reactAddons2["default"].createClass({
		...
		getInitialState: function getInitialState() {
			return {
				...
				mounted: false,
				tree_data: null,
				selected: _immutable2["default"].List(this.props.defaultSelected || []),
		...
		componentDidMount: function componentDidMount() {
			if (!this.state.mounted) {
				var data = _immutable2["default"].List(this.props.data);
				this.buildTree(data);
			}

			if (this.state.selected) {
				this.handleSelect(_immutable2["default"].List(this.props.defaultSelected));
			}
		...
		shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
			this.rebuildTree = this.rebuildTree || !_immutable2["default"].List(nextProps.data).equals(_immutable2["default"].List(this.props.data));
		...
		buildTree: function buildTree() {
			...
			var data = arguments.length <= 0 || arguments[0] === undefined ? _immutable2["default"].List(this.props.data) : arguments[0];

			var raw = data.toJS();
			var tree_data = null;
			var expandedPaths = [];
			var selection = this.state.selected.toJS();
			...
			this.setState({
				...
				rawdata: _immutable2["default"].List(raw),
				tree_data: _immutable2["default"].List(tree_data)
			});
		},
		...
		triggerSelect: function triggerSelect(selection) {
			...
			if (typeof this.props.onSelect === 'function') {
				selectedNodes = _underscore2["default"].map(selection.toJS(), function (id) {
			...
			result = _underscore2["default"].map(data, function (item) {
				...
				return _reactAddons2["default"].createElement(
					_node2["default"],
					{
						...
						selection: _this4.state.selected,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports["default"] = _reactAddons2["default"].createClass({
		...
		checkSelections: function checkSelections() {
			...
			var children = [];
			var descendants = [];
			var selection = this.props.selection.toJS();
			...
			if (descendants.length) {
				inmediate = _underscore2["default"].intersection(children, selection).length == children.length;

				if (this.props.selectable == 'recursive') {
					recursive = _underscore2["default"].intersection(descendants, selection).length == descendants.length;
				}
			}
		...
		handleSingleSelect: function handleSingleSelect(e) {
			...
			if (!this.props.data.disabled) {
				...
				selection = _underscore2["default"].uniq(selection);
				this.triggerSelect(_immutable2["default"].List(selection));
				clearSelection();
		...
		handleChildrenSelect: function handleChildrenSelect() {
			...
			if (!inmediate) {
				selection = _underscore2["default"].union(selection, children);
				inmediate = true;
			} else {
				selection = _underscore2["default"].difference(selection, children);
				inmediate = false;
			}
		...
		triggerSelect: function triggerSelect() {
			...
			if (typeof this.props.onSelect == 'function') {
				this.props.onSelect(_immutable2["default"].List(selection));
			}
		},
